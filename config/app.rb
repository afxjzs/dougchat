...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'dougchat.afx.cc'
  config.app_name = 'dougchat'
  config.mailer.from = 'dougchat <no-reply@afx.cc>'
  ...
  #
  config.app_secret = 'gIi9_dmmvuVfJki4H39YNDXc0pEJh0vrUgt7PM0nUYfTWdtEOvcSlXv6wqHb0jSsT7I'
  ...
  if ENV['MONGODB_URI'].present?
    config.db_uri = ENV['MONGODB_URI'] # you will have to set this on heroku
  else
